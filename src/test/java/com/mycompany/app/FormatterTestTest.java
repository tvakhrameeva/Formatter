...
public class FormatterTestTest extends TestCase  {
     ...
     * Rigourous Test :-)
     */
    public void testFormatterTest22() throws EndOfSourceException {
        StringReader reader = new StringReader("eeee;{};lmm");
        Formatter formatter = new Formatter();
        assertTrue(formatter.format(reader).equals(new String("eeee;\n{\n}\n;\nlmm")));
    }
    public void testFormatterTest1() throws EndOfSourceException {
        StringReader reader = new StringReader("eeeeeeee");
        Formatter formatter = new Formatter();
        assertTrue(formatter.format(reader).equals(new String( "eeeeeeee")));
    }
    public void testFormatterTest2() throws EndOfSourceException {
        StringReader reader = new StringReader("eeee;");
        Formatter formatter = new Formatter();
        assertTrue(formatter.format(reader).equals("eeee;"));
    }
    public void testFormatterTest3() throws EndOfSourceException {
        StringReader reader = new StringReader("eeee;e");
        Formatter formatter = new Formatter();
        assertTrue(formatter.format(reader).equals("eeee;\ne"));
    }
    public void testFormatterTest4() throws EndOfSourceException {
        StringReader reader = new StringReader(";");
        Formatter formatter = new Formatter();
        assertTrue(formatter.format(reader).equals(";"));
    }
    public void testFormatterTest5() throws EndOfSourceException {
        StringReader reader = new StringReader("\n;");
        Formatter formatter = new Formatter();
        assertTrue(formatter.format(reader).equals(";"));
    }

    public void testFormatterTest6() throws EndOfSourceException {
        StringReader reader = new StringReader("{{{{");
        Formatter formatter = new Formatter();
        assertTrue(formatter.format(reader).equals("{\n{\n{\n{"));
    }
    public void testFormatterTest7() throws EndOfSourceException {
        StringReader reader = new StringReader("}}}}");
        Formatter formatter = new Formatter();
        assertTrue(formatter.format(reader).equals("}\n}\n}\n}"));
    }
    public void testFormatterTest8() throws EndOfSourceException {
        StringReader reader = new StringReader("\n");
        Formatter formatter = new Formatter();
        assertTrue(formatter.format(reader).equals(""));
    }

    public void testFormatterTest9() throws EndOfSourceException {
        StringReader reader = new StringReader("");
        Formatter formatter = new Formatter();
        assertTrue(formatter.format(reader).equals(""));
    }
    public void testFormatterTest10() throws EndOfSourceException {
